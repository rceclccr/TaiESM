...
!cjshiu need to have a parameterization for Sundqvist's 
  ...
  !--------------------------------------------------- !
   ...
   public :: ini_macro, mmacro_pcond_updf, aist_vector, aist_single, astG_RHU_single, astG_PDF_single, CAMstfrac
...
subroutine uniform_pdf_register()
!cjshiu
     !------------------------------------------------ !
...
end subroutine uniform_pdf_register
!cjshiu end add sub
...
!cjshiu add pbuf into the following subroutine
   ...
   subroutine mmacro_pcond_updf( lchnk      , ncol       , dt         , p            , dp         ,              &
...
!cjshiu   print*,'cjshiu end of mmacro_pcond T0= ',T0
   ...
   return
   end subroutine mmacro_pcond_updf
...
!cjshiu add end
   ...
   if( CAMstfrac ) then
       ...
       call astG_PDF_single(U_nc,p,qv,landfrac,snowh,al_st_nc,G_nc,icol,k,lchnk,pbuf)
...
end module cldwat2m_macro_updf

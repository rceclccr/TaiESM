...
!     write(iulog,*)'in fpvs:c1xpvs=',c1xpvs,'c2xpvs=',c2xpvs, 'nxpvs',nxpvs
    jx=min(xj,nxpvs-1._krealfp)
!     write(iulog,*)'in fpvs:tbpvs(jx)=',tbpvs(jx),'tbpvs(jx+1)',tbpvs(jx+1)
    fpvs=tbpvs(jx)+(xj-jx)*(tbpvs(jx+1)-tbpvs(jx))
!    write(iulog,*)'in fpvs:fpvs=',fpvs,'xj=',xj,'t=',t
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  end function
!-------------------------------------------------------------------------------

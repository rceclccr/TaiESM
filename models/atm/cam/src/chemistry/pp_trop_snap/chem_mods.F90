...
!--------------------------------------------------------------
      ...
      implicit none
      save
      integer, parameter :: hetcnt = 23, & ! number of heterogeneous processes
                            ...
                            gas_pcnst = 23, & ! number of "gas phase" species
                            nfs = 8, & ! number of "fixed" species
                            relcnt = 0, & ! number of relationship species
                            grpcnt = 0, & ! number of group members
                            nzcnt = 25, & ! number of non-zero matrix entries
                            ...
                            clscnt4 = 23, & ! number of species in implicit class

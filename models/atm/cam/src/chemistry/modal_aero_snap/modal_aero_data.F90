...
!--------------------------------------------------------------
  ...
  character(len=*),parameter ::  specname_amode(ntot_aspectype) = (/ 'sulfate   ', 'ammonium  ', 'nitrate   ', &
...
#if ( defined MODAL_AERO_7MODE )
    real(r8), parameter :: specmw_amode(ntot_aspectype)   = (/  96.0_r8,  18.0_r8,  62.0_r8,   12.0_r8,   12.0_r8,   12.0_r8,  58.5_r8, 135.0_r8 /)
#elif ( defined MODAL_AERO_3MODE )
    real(r8), parameter :: specmw_amode(ntot_aspectype)   = (/ 115.0_r8, 115.0_r8,  62.0_r8,   12.0_r8,   12.0_r8,   12.0_r8,  58.5_r8, 135.0_r8 /)
#endif
    ...
    integer, parameter ::     mprogsfc_amode(ntot_amode)   = (/ 1, 1, 1/)  !by ICTsai
    integer, parameter ::     mcalcwater_amode(ntot_amode) = (/ 1, 1, 1/)
#endif
...
!    real(r8), parameter ::     sigmaglo_amode(ntot_amode)   = (/ 1.050, 1.050, 1.050 /)
!    real(r8), parameter ::     sigmaghi_amode(ntot_amode)   = (/ 2.300, 2.300, 2.300 /)
!
!#endif
...
!#endif
    ...
    !   input sigmag_amode
    real(r8) :: sgnum_amode(ntot_amode)
    real(r8) :: sigmag_amode(ntot_amode)
    real(r8) :: sigmaglo_amode(ntot_amode) !ICTsai
    real(r8) :: sigmaghi_amode(ntot_amode) !ICTsai
    ...
    integer :: msectional = -1
      ...
      integer                                               &   !
          ...
          lsfcptr_amode ( ntot_amode ),                     &   ! added by ICTsai
          lsfcptrcw_amode ( ntot_amode )            
      ...
      real(r8) ::                                 &   !
          ...
          voltosfclo_amode( ntot_amode ),        &   ! added by ICTsai
          voltosfchi_amode( ntot_amode ),         &   !
          voltosfc_amode( ntot_amode )

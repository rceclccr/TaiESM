...
!------------------------------------------------------------------------
   ...
   !!=== Added by Wei-Liang Lee
            grc%stdev_elev(beg:end),     &
            grc%sky_view(beg:end),       &
            grc%terrain_config(beg:end), &
            grc%sinsl_cosas(beg:end),    &
            grc%sinsl_sinas(beg:end),    &
   !!=== End Wei-Liang Lee
...
!------------------------------------------------------------------------
   ...
   !!=== Added by Wei-Liang Lee
    allocate(pps%fd_3d_adjust(beg:end,1:numrad))
   !!=== End Wei-Liang Lee
   ...
   !!=== Added by Wei-Liang Lee
    pps%fd_3d_adjust(beg:end,:numrad) = 1.0_r8
   !!=== End Wei-Liang Lee
    pps%u10(beg:end) = nan
...
!------NTUAS for irrigation
  if (irri_transient) then
    allocate(cps%irri4d(beg:end,1:100,1:12))
    cps%irri4d(beg:end,1:100,1:12) = nan
  else if (irri_climatology) then
    allocate(cps%irri4d2(beg:end,1:12))
    cps%irri4d2(beg:end,1:12) = nan
  endif
!------------

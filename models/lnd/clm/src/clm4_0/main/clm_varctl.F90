...
!
  ...
  character(len=256), public :: f3dtopo    = ' '        ! parameters for 3D topography effect on radiation ! Lee
  character(len=256), public :: firriclima   = ' '      ! climatological irrigation file name, NTUAS for irrigation 
  character(len=256), public :: firritransient   = ' '  ! transient irrigation file name, NTUAS for irrigation
!
! Landunit logic
!
